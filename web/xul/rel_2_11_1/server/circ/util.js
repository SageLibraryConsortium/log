        ...
        if (check.ilsevent == 0 || check.ilsevent == 3 || check.ilsevent == 1202) {
                ...
                case 8: /* ON HOLDS SHELF */
                    ...
                    if (!auto_print) {
                        rv = error.yns_alert_formatted(
                            ...
                            '/xul/rel_2_11_1/server/skin/media/images/holdshelf.png'
                        );
                    } else {
                ...
                case 15: // ON_RESERVATION_SHELF
                    ...
                    if (!auto_print) {
                        rv = error.yns_alert_formatted(
                            ...
                            null,
                            document.getElementById('circStrings').getString('staff.circ.confirm.msg'),
                            '/xul/rel_2_11_1/server/skin/media/images/reserve.png'
                        );
                    }
                    if (rv == 0) {
                        try {
            ...
            if (!auto_print) {
                rv = error.yns_alert_formatted(
                    ...
                    null,
                    document.getElementById('circStrings').getString('staff.circ.confirm.msg'),
                    '/xul/rel_2_11_1/server/skin/media/images/transit.png'
                );
            } else {
                if (suppress_popups && !no_print_prompting) {
                    // FIXME: add SFX and/or GFX
            ...
            if (!suppress_popups) {
                rv = error.yns_alert_formatted(
                    ...
                    null,
                    document.getElementById('circStrings').getString('staff.circ.confirm.msg'),
                    '/xul/rel_2_11_1/server/skin/media/images/stop_sign.png'
                );
            } else {
                // FIXME: add SFX and/or GFX
                sound.circ_bad();
